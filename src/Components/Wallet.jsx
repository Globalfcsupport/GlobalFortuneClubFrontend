    ...
    <div className=" text-sm w-full flex flex-col">
      <div className="flex justify-between bg-primary p-5">
        ...
        <div className="flex flex-col justify-end items-end">
          ...
          <p className="mt-1 bg-white border rounded-md w-28 text-right py-1 px-2 pl-5">1234</p>
        </div>
      </div>
      <div className="flex duration-200 relative justify-between px-3 bg-primary items-center w-full">
        <button onClick={() => handleTabClick('All')} className={`w-28 py-2 flex flex-col justify-center items-center duration-200 focus:outline-none ${activeTab === 'All' ? 'bg-white text-blue-800 rounded-t-md' : 'text-white'}`}>
          All <p className='w-14 h-1 bg-primary rounded-full flex justify-center items-center'></p>
        </button>
        <button onClick={() => handleTabClick('Crypto')} className={`w-28 py-2 flex flex-col justify-center items-center duration-200 focus:outline-none ${activeTab === 'Crypto' ? 'bg-white text-blue-800 rounded-t-md' : 'text-white'}`}>
          Crypto <p className='w-14 h-1 bg-primary rounded-full flex justify-center items-center'></p>
        </button>
        <button onClick={() => handleTabClick('Internal')} className={`w-28 py-2 flex flex-col justify-center items-center duration-200 focus:outline-none ${activeTab === 'Internal' ? 'bg-white text-blue-800 rounded-t-md' : 'text-white'}`}>
          Internal <p className='w-14 h-1 bg-primary rounded-full flex justify-center items-center'></p>
        </button>
